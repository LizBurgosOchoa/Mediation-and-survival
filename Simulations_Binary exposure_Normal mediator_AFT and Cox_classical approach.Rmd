---
title: "Simulations: Binary exposure, Normal mediator AFT and Cox, classical approach"
output: html_notebook
editor_options: 
  chunk_output_type: inline
---

This RNotebook contains the code necessary to replicate the results for scenarios with binary exposure and normal mediator (reported in Additional File 1). 
...
#Change to desired directory
write.table(results.sim.cl.Cox, "C:/Users/liz_c/Dropbox/Survival/R code/Classical mediation approach/Full results table/results.sim.cl.Cox.BN.txt", sep="\t")
