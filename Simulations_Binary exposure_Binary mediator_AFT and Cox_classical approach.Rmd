---
title: "Simulations: Binary exposure, Binary mediator AFT and Cox, classical approach"
output: html_notebook
editor_options: 
  chunk_output_type: inline
---

This RNotebook contains the code necessary to replicate the results for scenarios with binary exposure and binary mediator (reported in Additional File 1). 
