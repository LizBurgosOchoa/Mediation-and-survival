---
title: 'Simulations: Normal exposure, normal mediator AFT and Cox, classical approach'
output:
  html_document:
  df_print: paged
...
---
This RNotebook contains the code necessary to replicate the results for scenarios with normal exposure and normal mediator (reported in paper). 
