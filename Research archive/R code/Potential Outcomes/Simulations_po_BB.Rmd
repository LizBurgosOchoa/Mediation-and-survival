---
title: "Simulations potential outcomes approach: Binary exposure, binary mediator AFT and Cox, counterfactual approach"
...
This RNotebook contains the code necessary to replicate the results for scenarios with binary exposure and binary mediator, using the potential outcomes mediation approach (reported in Additional File 1). 
