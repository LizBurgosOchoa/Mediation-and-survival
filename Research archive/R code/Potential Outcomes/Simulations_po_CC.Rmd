---
title: "Simulations potential outcomes approach: continuous exposure, continuous mediator AFT and Cox, counterfactual approach"
output: html_notebook
editor_options: 
  chunk_output_type: inline
---
This RNotebook contains the code necessary to replicate the results for scenarios with continuous exposure and continuous mediator, using the potential outcomes mediation approach (reported in Additional File 1). 
