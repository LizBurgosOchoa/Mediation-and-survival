---
title: 'Simulations classical mediation approach: AFT and Cox models, continuous exposure and continuous mediator'
output:
  html_document:
  df_print: paged
...
---
This RNotebook contains the code necessary to replicate the results for scenarios with continuous exposure and continuous mediator, using the classical mediation approach (reported in paper). 
...
nc_1.5_250_AFT <- sim_rare_ev(0,1.5,"NC",250, "NORM", "NORM", "AFT")
nonrare_1.5_250_AFT <- sim_rare_ev(280,1.5,"40",250, "NORM", "NORM", "AFT")
rare_1.5_250_AFT <- sim_rare_ev(20,1.5,"90",250, "NORM", "NORM", "AFT")

#SHAPE 1
nc_1_250_AFT <- sim_rare_ev(0,1,"NC",250, "NORM", "NORM", "AFT")
nonrare_1_250_AFT <- sim_rare_ev(360,1,"40",250, "NORM", "NORM", "AFT")
rare_1_250_AFT <- sim_rare_ev(20,1,"90",250, "NORM", "NORM", "AFT")

#SHAPE 2/3
nc_23_250_AFT <- sim_rare_ev(0,2/3,"NC",250, "NORM", "NORM", "AFT")
nonrare_23_250_AFT <- sim_rare_ev(540,2/3,"40",250, "NORM", "NORM", "AFT")
rare_23_250_AFT <- sim_rare_ev(12,2/3,"90",250, "NORM", "NORM", "AFT")


#500 SAMPLE SIZE
#SHAPE 1.5
nc_1.5_500_AFT <- sim_rare_ev(0,1.5,"NC",500, "NORM", "NORM", "AFT")
nonrare_1.5_500_AFT <- sim_rare_ev(280,1.5,"40",500, "NORM", "NORM", "AFT")
rare_1.5_500_AFT <- sim_rare_ev(20, 1.5,"90",500, "NORM", "NORM", "AFT")

#SHAPE 1
nc_1_500_AFT <- sim_rare_ev(0,1,"NC",500, "NORM", "NORM", "AFT")
nonrare_1_500_AFT <- sim_rare_ev(360,1,"40",500, "NORM", "NORM", "AFT")
rare_1_500_AFT <- sim_rare_ev(20,1,"90",500, "NORM", "NORM", "AFT")

#SHAPE 2/3
nc_23_500_AFT <- sim_rare_ev(0,2/3,"NC",500, "NORM", "NORM", "AFT")
nonrare_23_500_AFT <- sim_rare_ev(540,2/3,"40",500, "NORM", "NORM", "AFT")
rare_23_500_AFT <- sim_rare_ev(12,2/3,"90",500, "NORM", "NORM", "AFT")

#1000 SAMPLE SIZE
#SHAPE 1.5
nc_1.5_1000_AFT <- sim_rare_ev(0,1.5,"NC",1000, "NORM", "NORM", "AFT")
nonrare_1.5_1000_AFT <- sim_rare_ev(280,1.5,"40",1000, "NORM", "NORM", "AFT")
rare_1.5_1000_AFT <- sim_rare_ev(20,1.5,"90",1000, "NORM", "NORM", "AFT")

#SHAPE 1
nc_1_1000_AFT <- sim_rare_ev(0,1,"NC",1000, "NORM", "NORM", "AFT")
nonrare_1_1000_AFT <- sim_rare_ev(360,1,"40",1000, "NORM", "NORM", "AFT")
rare_1_1000_AFT <- sim_rare_ev(15,1,"90",1000, "NORM", "NORM", "AFT")

#SHAPE 2/3
nc_23_1000_AFT <- sim_rare_ev(0,2/3,"NC",1000, "NORM", "NORM", "AFT")
nonrare_23_1000_AFT <- sim_rare_ev(540,2/3,"40",1000, "NORM", "NORM", "AFT")
rare_23_1000_AFT <- sim_rare_ev(15,2/3,"90",1000, "NORM", "NORM", "AFT")
...
write.table(results.sim.cl.aft, "C:/Users/liz_c/Dropbox/Survival/R code/Classical mediation approach/Full results table/results.sim.cl.aft.txt", sep="\t")
...
nc_1.5_250_COX <- sim_rare_ev(0,1.5,"NC",250, "NORM", "NORM", "COX")
nonrare_1.5_250_COX <- sim_rare_ev(280,1.5,"40",250, "NORM", "NORM", "COX")
rare_1.5_250_COX <- sim_rare_ev(20,1.5,"90",250, "NORM", "NORM", "COX")

#SHAPE 1
nc_1_250_COX <- sim_rare_ev(0,1,"NC",250, "NORM", "NORM", "COX")
nonrare_1_250_COX <- sim_rare_ev(360,1,"40",250, "NORM", "NORM", "COX")
rare_1_250_COX <- sim_rare_ev(20,1,"90",250, "NORM", "NORM", "COX")

#SHAPE 2/3
nc_23_250_COX <- sim_rare_ev(0,2/3,"NC",250, "NORM", "NORM", "COX")
nonrare_23_250_COX <- sim_rare_ev(540,2/3,"40",250, "NORM", "NORM", "COX")
rare_23_250_COX <- sim_rare_ev(12,2/3,"90",250, "NORM", "NORM", "COX")


#500 SAMPLE SIZE
#SHAPE 1.5
nc_1.5_500_COX <- sim_rare_ev(0,1.5,"NC",500, "NORM", "NORM", "COX")
nonrare_1.5_500_COX <- sim_rare_ev(280,1.5,"40",500, "NORM", "NORM", "COX")
rare_1.5_500_COX <- sim_rare_ev(20, 1.5,"90",500, "NORM", "NORM", "COX")

#SHAPE 1
nc_1_500_COX <- sim_rare_ev(0,1,"NC",500, "NORM", "NORM", "COX")
nonrare_1_500_COX <- sim_rare_ev(360,1,"40",500, "NORM", "NORM", "COX")
rare_1_500_COX <- sim_rare_ev(20,1,"90",500, "NORM", "NORM", "COX")

#SHAPE 2/3
nc_23_500_COX <- sim_rare_ev(0,2/3,"NC",500, "NORM", "NORM", "COX")
nonrare_23_500_COX <- sim_rare_ev(540,2/3,"40",500, "NORM", "NORM", "COX")
rare_23_500_COX <- sim_rare_ev(12,2/3,"90",500, "NORM", "NORM", "COX")

#1000 SAMPLE SIZE
#SHAPE 1.5
nc_1.5_1000_COX <- sim_rare_ev(0,1.5,"NC",1000, "NORM", "NORM", "COX")
nonrare_1.5_1000_COX <- sim_rare_ev(280,1.5,"40",1000, "NORM", "NORM", "COX")
rare_1.5_1000_COX <- sim_rare_ev(20,1.5,"90",1000, "NORM", "NORM", "COX")

#SHAPE 1
nc_1_1000_COX <- sim_rare_ev(0,1,"NC",1000, "NORM", "NORM", "COX")
nonrare_1_1000_COX <- sim_rare_ev(360,1,"40",1000, "NORM", "NORM", "COX")
rare_1_1000_COX <- sim_rare_ev(15,1,"90",1000, "NORM", "NORM", "COX")

#SHAPE 2/3
nc_23_1000_COX <- sim_rare_ev(0,2/3,"NC",1000, "NORM", "NORM", "COX")
nonrare_23_1000_COX <- sim_rare_ev(540,2/3,"40",1000, "NORM", "NORM", "COX")
rare_23_1000_COX <- sim_rare_ev(15,2/3,"90",1000, "NORM", "NORM", "COX")
...
#Change to desired directory
write.table(results.sim.cl.Cox, "C:/Users/liz_c/Dropbox/Survival/R code/Classical mediation approach/Full results table/results.sim.cl.Cox.txt", sep="\t")
...
The following code generates the plots corresponding to Figure 2 in paper. 
```{r}
#PROPORTIONAL BIAS
